...
public class Resource08_TypeAttributeDomain extends ServerResource {
    ...
    @Get
    public Representation getTypeAttributeDomain() {
...
//        ServletContext context = (ServletContext) getContext().getServerDispatcher().getContext().getAttributes().get("org.restlet.ext.servlet.ServletContext");
        ...
        System.out.println("CO 8: GET ATTRIBUTE DOMAIN OF CONTEXT ENTITY TYPE: eId Type = '" + eType + "'" + ", attribute domain = '" + attrDomainName + "'");
...
//            regStore.openDb4o();
            ...
            crrl = regFilter.getContRegContainsETypeAttrDomain(result, eType, attrDomainName);
